...
<section class="gallery py-5">
    <div class="container">
        <div class="row justify-content-center g-4">
            <div class="col-md-4">
                <img src="${pageContext.request.contextPath}/images/room.png" alt="Room" class="gallery-img w-100">
            </div>
            <div class="col-md-4">
                <img src="${pageContext.request.contextPath}/images/patio.png" alt="Patio" class="gallery-img w-100">
            </div>
            <div class="col-md-4">
                <img src="${pageContext.request.contextPath}/images/spa.png" alt="Spa" class="gallery-img w-100">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="newsletter-box">
                    <div class="newsletter-content d-flex align-items-center">
                        ...
                        <div class="newsletter-text flex-grow-1">
                            ...
                            <!-- Newsletter form wired to POST /api/home/newsletter -->
                            ...
                            <small id="newsletter-msg" class="d-block mt-2"></small>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Newsletter JS (calls /api/home/newsletter) -->
<script>
  const NEWSLETTER_URL = "${pageContext.request.contextPath}/api/home/newsletter";
