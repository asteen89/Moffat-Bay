...
<section class="container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card h-100 shadow-sm">
                <img class="card-img-top"
                     src="${pageContext.request.contextPath}/images/attractions/kayaking.jpg"
                     alt="Kayaking">
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card h-100 shadow-sm">
                <img class="card-img-top"
                     src="${pageContext.request.contextPath}/images/attractions/whale.jpg"
                     alt="Whale Watching">
                <div class="card-body py-3 text-center">
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card h-100 shadow-sm">
                <img class="card-img-top"
                     src="${pageContext.request.contextPath}/images/attractions/hiking.jpg"
                     alt="Hiking">
                <div class="card-body py-3 text-center">
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card h-100 shadow-sm">
                <img class="card-img-top"
                     src="${pageContext.request.contextPath}/images/attractions/scuba-diving.jpg"
                     alt="Scuba Diving">
                <div class="card-body py-3 text-center">
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="card h-100 shadow-sm">
                <img class="card-img-top"
                     src="${pageContext.request.contextPath}/images/attractions/Maps_Resort.webp"
...
<section class="container pb-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card h-100 shadow-sm">
                <img class="card-img-top"
                     src="${pageContext.request.contextPath}/images/attractions/room.jpeg"
                     alt="Lodge Rooms">
                <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card h-100 shadow-sm">
                <img class="card-img-top" src="${pageContext.request.contextPath}/images/attractions/marina.webp" alt="Marina">
                <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card h-100 shadow-sm">
                    ...
                    <img class="card-img-top" src="${pageContext.request.contextPath}/images/attractions/spa.png" alt="Spa">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="card h-100 shadow-sm">
                <img class="card-img-top" src="${pageContext.request.contextPath}/images/attractions/tour.jpg" alt="Guided Tours">
                <div class="card-body">
